...
public class PlayerLightningAttack : PlayerBaseState
{
   ...
   // private Attack attack;
    ...
    public PlayerLightningAttack(PlayerStateMachine stateMachine, int attackIndex) : base(stateMachine){
        
       // attack = stateMachine.Attacks[attackIndex];
        magicAttack = stateMachine.MagicAttacks2[attackIndex];
    }

    public override void Enter()
    {
        stateMachine.Slot6.SetActive(true);
    ...
    {
        stateMachine.Slot6.SetActive(false);
